  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#121212] px-6 py-16 text-[#FAFAFA]">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-32 left-1/2 h-[320px] w-[320px] -translate-x-1/2 rounded-full bg-[#7B61FF]/25 blur-[110px]" />
        <div className="absolute bottom-0 right-0 h-[260px] w-[260px] rounded-full bg-[#FF7A00]/20 blur-[120px]" />
      </div>
      ...
      <section className="relative mx-auto flex w-full max-w-md flex-col gap-8">
        <header className="space-y-3">
          ...
          <h1 className="text-3xl font-semibold">Start with a User account</h1>
          <p className="text-sm text-[#9CA3AF]">
            Every member begins as a User, then applies for Merchant, Agent, or
            Admin roles when ready.
          </p>
        </header>

        <div className="rounded-3xl border border-[#2A2A2A] bg-[#161616] p-5 text-sm text-[#D1D5DB]">
          <p className="text-[#FAFAFA]">Your base account includes:</p>
          <ul className="mt-3 space-y-2 text-xs text-[#9CA3AF]">
            <li>Browse the promo feed and view details instantly.</li>
            <li>Claim promos, save favorites, and track history.</li>
            <li>Access profile and basic settings anytime.</li>
          </ul>
        </div>
        ...
        >
          ...
          {successMessage ? (
            <p className="mt-4 rounded-2xl border border-[#00E5A8]/40 bg-[#00E5A8]/10 px-4 py-3 text-xs text-[#FAFAFA]">
              {successMessage}
            </p>
          ) : null}
          ...
          <p className="mt-6 text-center text-xs text-[#9CA3AF]">
            ...
            <Link href="/login" className="text-[#FF7A00]">
              Log in
            </Link>
          </p>
        </form>
